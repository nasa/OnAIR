...
# from src.data_driven_components.associativity_data_manager import AssociativityDataManager

# class Associativity:
#     def __init__(self, headers=[], sample_input=[]):
#         self.verbose = False
#         self.visualize_graph = False
#         self.min_support = 0.0045
#         self.min_confidence = 0.2
#         self.min_lift = 3
#         self.min_length = 2
#         self.window_size = 20 ##make sure common vars in this and data manager are set sync
#         self.associativityDataManager = AssociativityDataManager()
#         self.frame_id = 0
...
#         if data != -1:
#             association_rules = list(apriori(data)) ##computes the association rules
