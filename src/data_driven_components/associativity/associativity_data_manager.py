...
class AssociativityDataManager:
    def __init__(self):
        ...
        self.model_path = '/home/chris/Desktop/RAISR-2.0/src/util/data_generation_scripts/models'
    ...
    def convert_frames_to_categorical(self):
        for sensor_idx in range(len(self.frames[0])):
            ...
            if sensor_idx >= 4 and sensor_idx != 6 and sensor_idx != 9: ##hacky - change 
                ...
                preds = self.model.predict([input_data_np, input_data_np, input_data_np]) ## do we need to do midpt preprocessing first?
