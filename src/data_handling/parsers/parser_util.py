...
def extract_configs(configFilePath, configFiles):
    ss_assigns = {}
    test_assigns = {}
    desc_assigns = {}

    for cFile in configFiles:
        filename, subsystem_assignments, tests, descs = extract_config(configFilePath, cFile)
...
def extract_config(configFilePath, configFile):
    data_source = process_filepath(configFile)
...
def process_filepath(path, return_config=False):
